...
def Token_token():
	...
	print("")
	try:
		tok = open('/sdcard/Download/.Jaikumar.txt', 'r').read()
		dec = base64.b64decode(tok)
		if len(dec) < 50:
		    not_reg()
		r = requests.get("pastebin.com/raw/QBX03uGX").text
		if dec in r:
	...
	try:
		...
		if len(dec) < 50:
		    not_reg()
		r = requests.get("https://pastebin.com/raw/WGiRSytV").text
		if dec in r:
			main() #add your main menu when payment sucess
		else:
		    print('\t  \033[1;91m YOUR  Token_token  IS NOT  APPROVED :(').center(50)
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.Jaikumar.txt', 'w')
